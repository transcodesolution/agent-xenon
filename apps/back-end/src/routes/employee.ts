...
import { createEmployee, deleteEmployee, getEmployeeById, getEmployees, updateEmployee } from '../controllers/employee/employee';
...
router.put("/:employeeId", validateRoleAndPermissions([Permission.EMPLOYEE_UPDATE]), updateEmployee);
